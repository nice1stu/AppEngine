...
public class PyramidMesh: Mesh
{
    ...
    private  static readonly Vertex[] vertices =
    {
        ...
        new Vertex(new Vector(0,0, 0), Color.White, 0f,0f), // 8: top-left
        new Vertex(new Vector(0, 0, 0), Color.White, 1f, 0f), // 9: top-right
        new Vertex(new Vector(0,0, 0), Color.White, 1f,1f), // 10: top-right back
        new Vertex(new Vector(0, 0, 0), Color.White, 0f, 1f), // 11: top-left back
