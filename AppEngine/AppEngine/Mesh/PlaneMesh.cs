...
public class PlaneMesh: Mesh
{
    ...
    private  static readonly Vertex[] vertices =
    {
        ...
        new Vertex(new Vector(-10f,-0.5f, 10f), Color.White, 0f,0f), // 12: bottom-left
        new Vertex(new Vector(10f, -0.5f, 10f), Color.White, 1f, 0f), // 13: bottom-right
        new Vertex(new Vector(10f,-0.5f, -10f), Color.White, 1f,1f), // 14: bottom-right back
        new Vertex(new Vector(-10f, -0.5f, -10f), Color.White, 0f, 1f), // 15: bottom-left back
    };
